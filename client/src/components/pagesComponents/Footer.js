      ...
      <AppBar color="secondary" className={classes.test}>
        {width > 720 && (
          <div>
            ...
            >
              Get In Touch With Bunk Manager
            </h1>
            <h2 style={{ fontFamily: "cursive", marginTop: "0%" }}>
              We love feedback.Fill out form below and we'll get back to you as
              soon as possible.
            </h2>
          </div>
        )}
        ...
        >
          ...
          {width > 720 && (
            <div style={{ margin: "1% 1% 0% 1%" }}>
              <a
                href="https://github.com/ASHISH-GITHUB2495/GRIP_BasicBankingSystem_2021"
                target="_blank"
              >
                <GitHubIcon
                  className={classes.icon}
                  style={{ height: "4%", width: "4%", color: "white" }}
                />
              </a>
              <a
                href="https://ashish-github2495.github.io/MyPortfolio.github.io/"
                target="_blank"
              >
                <FacebookIcon
                  className={classes.icon}
              ...
              <a
                href="https://www.stopstalk.com/user/profile/ZeroHu0"
                target="_blank"
              >
                <TwitterIcon
                  className={classes.icon}
