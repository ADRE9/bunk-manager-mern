...
const {isRequestValidated,validateSubject,validateSubjectUpdation} = require('../middlewares/validators')  

router.post('/api/subject/new', auth, validateSubject, isRequestValidated, createSubject);
...
router.patch('/api/subject/:id', auth,subjectRequest, validateSubjectUpdation, isRequestValidated, editSubject);
