...
const { validateSignupRequest, isRequestValidated, validateLogin,validateUpdationUser } = require("../middlewares/validators")
...
router.patch('/api/auth', auth , validateUpdationUser, isRequestValidated,updateUser);
